    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            try:
                ...
                message = 'Thanks for Verfying your City Library account. Please click the below link to continue..  http://ec2-34-255-41-226.eu-west-1.compute.amazonaws.com:8000/catalog'
